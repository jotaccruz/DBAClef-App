...
#pyinstaller --windowed --onefile --add-binary "./files/dbaClef.png;files"
...
def getFileUrl(filename,directory):
    ...
    FileName = running_dir + filename #"dbaClef.png"
    return FileName 
...
#Failsafe Operator
    ...
    for rows in mssqldetail2sql(selected_row['Server'],selected_row['Instance'],"master",\
                           selected_row['User'],selected_row['Pwd'],sqlexec1,\
                           sqlexec2):
        if (rows[1]=='1'):
...
iconFileName=getFileUrl("dbaClef.png","files")
